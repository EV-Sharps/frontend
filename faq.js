...
const FAQ = [
	...
	},
	{
		...
		answer: `<p>Sign in, then select the <strong>star beside a player</strong> on a prop page to add or remove them from your watchlist. The selection follows the player across supported prop pages for that sport.</p><p>Open the <a href="bets.html">bet tracker</a> to find your watchlist and tracked bets together.</p>`
	},
	{
